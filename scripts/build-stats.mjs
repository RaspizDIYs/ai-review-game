...
/**
 * Порог показа. Стоял на пяти — и это делало фичу невидимой, пока играют
 * два человека: у каждой задачи по одному показу, процент не появляется никогда.
 * Три плюс явный размер выборки честнее: маленькое число само себя
 * дискредитирует, а большое говорит за себя.
 */
const MIN_SAMPLE = 3
